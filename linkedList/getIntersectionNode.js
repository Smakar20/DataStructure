...
var getIntersectionNode = function(headA, headB) {
    var headALen = getLength(headA);
    var headBLen = getLength(headB);
    var diff = Math.abs(headALen-headBLen);
    (headALen < headBLen) ? headB = forward(headB,diff) : headA = forward(headA,diff);
